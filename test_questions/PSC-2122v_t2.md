...
.L1:
	movq %rdi, %r8 		# Copia array para r8
	imulq %rdx, %rax 	# Multiplica elem_size por i e armazena em rax
	addq %r8, %rax 		# Calcula o endereço do elemento atual
	movq %rax, %rdi 	# Coloca o endereço do elemento em rdi (parâmetro para do_it)
	call *%rcx 		# Chama a função do_it
	incq %rax 		# Incrementa i

.L2:
	cmpq %rsi, %rax 	# Compara i com size_array
	jl .L1 			# Se i < size_array, continua o loop
